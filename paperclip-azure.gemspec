# -*- encoding: utf-8 -*-
# stub: paperclip-azure 1.1.0.20220509152931 ruby lib
                              
Gem::Specification.new do |s|
  s.name = "paperclip-azure".freeze
  s.version = "1.1.0.20220509152931"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["scopear.com".freeze]
  s.date = "2022-02-20"
  s.description = "".freeze
  s.email = ["alain.bloch@scopear.com".freeze]
  ...
  s.homepage = "https://github.com/scopear/paperclip-azure".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<azure-storage-blob>.freeze, ["~> 2.0.3"])
      ...
      s.add_development_dependency(%q<activerecord-import>.freeze, ["~> 1.4"])
    ...
    s.add_dependency(%q<azure-storage-blob>.freeze, ["~> 2.0.3"])
    s.add_dependency(%q<hashie>.freeze, ["~> 3.5"])
    s.add_dependency(%q<addressable>.freeze, ["~> 2.5"])
    s.add_dependency(%q<paperclip>.freeze, [">= 4.3.6"])
    ...
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.16"])
    s.add_dependency(%q<activerecord>.freeze, [">= 4.2.0"])
    s.add_dependency(%q<activerecord-import>.freeze, ["~> 1.4"])
    s.add_dependency(%q<activemodel>.freeze, [">= 4.2.0"])
    s.add_dependency(%q<activesupport>.freeze, [">= 4.2.0"])
    s.add_dependency(%q<hoe>.freeze, [">= 0"])
    s.add_dependency(%q<hoe-bundler>.freeze, [">= 0"])
